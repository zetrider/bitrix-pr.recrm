...
$MESS ['PR_RECRM_F_IMG_ESTATE_W'] 		= "Ширина детальных изображений";
$MESS ['PR_RECRM_F_IMG_ESTATE_W_NOTE'] 	= "Изображения объекта";
$MESS ['PR_RECRM_F_IMG_ESTATE_H'] 		= "Высота детальных изображений";
$MESS ['PR_RECRM_F_IMG_ESTATE_H_NOTE'] 	= "Изображения объекта"; 
...
$MESS ['PR_RECRM_CREATE_TMP_FALSE'] 	= "Временный файл не создан, так как существует точно такойже файл ожидающий своей очереди для импорта или от CRM не получены все данные, повторите позже.";
$MESS ['PR_RECRM_CREATE_TMP_TRUE'] 	    = "Данные успешно скачены и занесены во временный файл";
