...
<strong>Событие OnAfterCheckResponse </strong><br>
Срабатывает после проверки валидного ответа от CRM перед формированием данных. Если Api CRM вернул не json, формирование данных будет прервано, импорт не будет запущен.<br>
<br>
<i>Событие содержит массив данных:</i><br>
...
<strong>Событие OnAfterGetJson </strong><br>
Если константа PR_RECRM_DEBUG_QUERY определена, срабатывает после каждого запроса к апи.
<br>
<i>Событие содержит массив данных:</i><br>
type (string) - тип запроса<br>
